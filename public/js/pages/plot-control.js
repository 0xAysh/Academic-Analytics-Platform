...
export function initPlotControls() {
  ...
  const chartTypes = $$('input[name="chartType"]');
  const axesConfig = $('#axesConfig');
  const pieDataConfig = $('#pieDataConfig');
  ...
  function updateSummary() {
    ...
    const itemXAxis = $('#summaryItemXAxis');
    const itemYAxis = $('#summaryItemYAxis');
    const itemPieData = $('#summaryItemPieData');
    const summaryXAxis = $('#summaryXAxis');
    const summaryYAxis = $('#summaryYAxis');
    const summaryPieData = $('#summaryPieData');
    const summaryChartTypes = $('#summaryChartTypes');
...
function getConfiguration() {
  ...
  const yAxis = $('#yAxis');
  const pieData = $('#pieData');
  const selectedChartType = Array.from($$('input[name="chartType"]')).find(radio => radio.checked);
...
/**
 * Get Y-axis data based on option
 */
...
/**
 * Get fallback data when transcript data is not available
 */
